export default {
    ...
    column: {
        ...
        bodyCell: ({ props, context, state, parent }) => ({
            class: [
                ...
                {
                    "overflow-hidden whitespace-nowrap border-y bg-clip-padding":
                        parent.instance?.$parentInstance?.$parentInstance
        ...
        filterAddButtonContainer:
            "[&>[data-pc-name=pcfilteraddrulebutton]]:w-full",
        rowToggleButton: {
            class: [
                "relative",
    ...
    bodyRow: ({ context, props }) => ({
        class: [
            ...
            {
                "bg-surface-0 text-surface-600 dark:bg-surface-900":
                    !context.selected,
            },
            {
                "font-bold bg-surface-0 dark:bg-surface-900 z-20":
                    props.frozenRow,
            },
            {
