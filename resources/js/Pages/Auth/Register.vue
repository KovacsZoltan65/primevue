                    ...
                    >
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <InputText id="name" type="text" 
                                       placeholder="Name" class="w-full md:w-[30rem] mb-8" 
                                       v-model="name" />
                            <!-- ./NAME -->
                            ...
                            <!-- CONFIRM PASSWORD -->
                            <label for="confirm_password" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Confirm Password</label>
                            <Password id="confirm_password" v-model="confirm_password" 
                            placeholder="Password" :toggleMask="true" class="mb-4" 
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <Link :href="route('login')" 
                                  class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Already registered?</Link>
                            </div>
                            <Button
                                label="Register"
                                class="w-full"
